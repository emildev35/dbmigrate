...
workbook = xlrd.open_workbook('excels/backup_jueves_26.xlsx')
activos_sheet = workbook.sheet_by_index(0)

sql = """
INSERT INTO Activos (%s) VALUES(%s)
"""
    ...
    for j in range(activos_sheet.ncols):
        ...
        if i == 0:
            ...
            if 'Codigo' in str(activos_sheet.cell(0, j).value):
                try:
                    val = str(int(activos_sheet.cell(i, j).value) + 11)
                except Exception:
                    pass
